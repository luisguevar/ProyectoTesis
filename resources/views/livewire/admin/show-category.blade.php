<div class="conteiner py-12">
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-auto">
                        <label>
                            <input wire:model.defer="createForm.color" type="radio" value="1" name="color">Si
                        </label>
                        <label>
                            <input wire:model.defer="createForm.color" type="radio" value="0" name="color">No
                        </label>
                    </div>
                </div>
            ...
            <div class="col-span-6 sm:col-span-4">
                <div class="flex items-center">
                    <p>¿Esta subcategoria necesita especificar tamaño?</p>
                    <div class="ml-auto">
                        <label>
                            <input wire:model.defer="createForm.size" type="radio" value="1" name="size">Si
                        </label>
                        <label>
                            <input wire:model.defer="createForm.size" type="radio" value="0" name="size">No
                        </label>
                    </div>
                </div>
        ...
        <x-slot name="actions">
            <x-jet-action-message class="mr-3" on="saved"> Categoria creada</x-jet-action-message>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aqui encontrarás todas las subcategorias agregadas
        </x-slot>
        <x-slot name="content">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <div class="flex items-center">
                        ...
                        <div class="ml-auto">
                            <label>
                                <input wire:model.defer="editForm.color" type="radio" value="1" name="color">Si
                            </label>
                            <label>
                                <input wire:model.defer="editForm.color" type="radio" value="0" name="color">No
                            </label>
                        </div>
                    </div>
                ...
                <div>
                    <div class="flex items-center">
                        ...
                        <div class="ml-auto">
                            <label>
                                <input wire:model.defer="editForm.size" type="radio" value="1" name="size">Si
                            </label>
                            <label>
                                <input wire:model.defer="editForm.size" type="radio" value="0" name="size">No
                            </label>
                        </div>
                    </div>
