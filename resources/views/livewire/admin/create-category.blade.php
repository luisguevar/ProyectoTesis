<div>
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input wire:model.defer="createForm.icon" type="text" class="w-full mt-1"></x-jet-input>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input wire:model="createForm.image" accept="image/*" type="file" class="w-full mt-1"
                    id="{{ $rand }}"></x-jet-input>
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            Aqui encontrarás todas las categorias agregadas
        </x-slot>
        <x-slot name="content">
        ...
        <x-slot name="content">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <x-jet-input wire:model.defer="editForm.icon" type="text" class="w-full mt-1"></x-jet-input>
                ...
                <div>
                    ...
                    <x-jet-input wire:model="editImage" accept="image/*" type="file" class="w-full mt-1"
                        id="{{ $rand }}"></x-jet-input>
