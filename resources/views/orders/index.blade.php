    ...
    <div class="conteiner py-12">
        ...
        <section class="grid lg:grid-cols-5 gap-6 text-white">
            ...
            <a href="{{ route('orders.index') . '? status=1' }}"
                ...
                <p class="uppercase text-2xl mt-2">Pendiente</p>
                <p class="text-center text-2xl ">
            ...
            <a href="{{ route('orders.index') . '? status=2' }}"
                ...
                <p class="uppercase text-2xl mt-2">Recibido</p>
                <p class="text-center text-2xl ">
            ...
            <a href="{{ route('orders.index') . '? status=3' }}"
                ...
                <p class="uppercase text-2xl mt-2">Enviado</p>
                <p class="text-center text-2xl ">
            ...
            <a href="{{ route('orders.index') . '? status=4' }}"
                ...
                <p class="uppercase text-2xl mt-2">Entregado</p>
                <p class="text-center text-2xl ">
            ...
            <a href="{{ route('orders.index') . '? status=5' }}"
                ...
                <p class="uppercase text-2xl mt-2">Anulado</p>
                <p class="text-center text-2xl ">
